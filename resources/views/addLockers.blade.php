...
<body>
  ...
  <style>
    ...
    .form-control:focus, .form-select:focus {
      ...
      box-shadow: 0 0 0 0.2rem rgba(40, 167, 69, 0.25); /* Green box shadow on focus */
    }
    .btn-custom {
        ...
        <div class="container">
            ...
            <form id="lockerForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="lockerNumber" placeholder="Enter locker number" required>
                </div>
    ...
    <script>
        ...
        document.getElementById('lockerForm').addEventListener('submit', function (event) {
            ...
            if (editingLockerId) {
                ...
                updateLocker(editingLockerId, lockerNumber, lockerStatus, studentLastName, studentFirstName, studentMiddleName, studentId, course, year, set, email);
            } else {
                // Add new locker
                addLocker(lockerNumber, lockerStatus, studentLastName, studentFirstName, studentMiddleName, studentId, course, year, set, email);
            }
        ...
        // Add locker
        function addLocker(number, status, studentLastName, studentFirstName, studentMiddleName, studentId, course, year, set, email) {
            lockers.push({
                id: lockerId++,
                number,
                status,
